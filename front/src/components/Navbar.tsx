    ...
    <nav className="fixed top-6 left-0 right-0 z-[999] px-6">
      <div className="max-w-7xl mx-auto px-6 py-4 rounded-full backdrop-blur-xl bg-black/40 border border-white/10 shadow-2xl flex items-center justify-between">
        ...
        <Link to="/" className="text-2xl font-bold text-white tracking-wider flex items-center gap-2">
          <img src="/icone.png" alt="Vroom-Vroom Logo" className="h-16" /> 
          <span>Vroom-Vroom</span>
        </Link>

        {/* Menu Desktop */}
        <div className="hidden md:flex gap-8 items-center">
          <Link to="/history" className="text-white/70 hover:text-white transition-colors text-sm font-medium">Notre Histoire</Link>
          <Link to="/stock" className="text-white/70 hover:text-white transition-colors text-sm font-medium">Stock</Link>
          <Link to="/services" className="text-white/70 hover:text-white transition-colors text-sm font-medium">Nos Services</Link>
        </div>
        ...
        <div className="flex items-center gap-4">
          <button 
            ...
            className="group flex items-center gap-2 px-3 py-2 rounded-full bg-white/5 hover:bg-blue-500/20 border border-white/10 hover:border-blue-500/50 transition-all duration-300 cursor-pointer"
          >
            <div className="w-8 h-8 rounded-full bg-gradient-to-tr from-blue-500 to-blue-600 p-[1px]">
